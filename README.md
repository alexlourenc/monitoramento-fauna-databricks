...
## Rascunho gerado por assistente de IA

Um rascunho de solução completa foi gerado pelo assistente de código do
Databricks (pandas + `requests`, sem persistência em tabela). Sua lógica
analítica serviu de referência para os notebooks 04 e 05, mas todo o código
deste repositório foi reimplementado em PySpark sobre as tabelas Delta deste
